    ...
    <Container className="min-h-[70vh]">
      <div className="flex flex-col justify-center md:flex-row">
        <div className="md:w-1/2 md:pr-12 lg:w-2/3">
          <div>
            <h2 className="text-4xl font-extrabold tracking-normal text-gray-700 sm:text-5xl lg:text-6xl">
              How We Work
            </h2>
        ...
        <div className="md:w-1/2 lg:w-1/3">
          <div className="aspect-w-16 aspect-h-9">
            <iframe
              width="560"
              height="315"
              src="https://www.youtube.com/embed/tfSmIRUYOrM?si=H0yPG_ebeMRBfTVS"
